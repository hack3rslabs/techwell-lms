                    ...
                    <TableBody>
                        {candidates.length === 0 ? (
                            ...
                            <TableRow key={candidate.id}>
                                ...
                                <TableCell>
                                    <span className={`px-2 py-1 text-xs rounded-full ${candidate.status === 'COMPLETED' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                                        {candidate.status === 'COMPLETED' ? 'Completed' : 'Closed'}
                                    </span>
                                </TableCell>
                                <TableCell>
