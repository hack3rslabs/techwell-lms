...
export default function CertificateViewer() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 py-12 px-4 flex flex-col items-center">
            ...
            {/* Toolbar */}
            <div className="max-w-[1000px] w-full flex flex-col sm:flex-row justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-8">
            ...
            <div className="w-full max-w-[1000px] overflow-x-auto pb-8 flex justify-center">
                ...
                <div style={{ transformOrigin: 'top center' }} className="sm:scale-100 scale-[0.3] md:scale-[0.7] lg:scale-100">
