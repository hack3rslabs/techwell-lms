...
export default function CourseList() {
    ...
    return (
        <div className="container py-8">
            ...
            <div className="mb-10 bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-2xl p-6 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden border-2 border-indigo-500/50">
                ...
                <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-teal-500 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
                
                <div className="z-10 relative">
                    <div className="inline-flex items-center rounded-full border border-indigo-400 bg-indigo-800/50 px-3 py-1 text-sm font-medium text-indigo-100 mb-3 backdrop-blur-sm">
                        <span className="flex h-2 w-2 rounded-full bg-teal-400 mr-2 animate-pulse"></span>
                        Live This Week
                    </div>
                    <h3 className="text-2xl font-bold mb-2">Upcoming Events & Webinars</h3>
                    <p className="text-indigo-100 max-w-xl">Join industry leaders for free masterclasses on AI, Web3, and Tech Placements. Don't miss out on our expert-led sessions!</p>
                </div>
                <div className="z-10 relative shrink-0">
                    <Button onClick={() => router.push('/events')} size="lg" className="bg-white text-indigo-900 hover:bg-indigo-50 font-bold shadow-lg w-full md:w-auto">
                        Explore Events
                    </Button>
                </div>
            </div>
