...
export default function FranchiseTemplatesPage() {
            ...
            <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold">
                        {editingTemplate ? 'Edit Co-branded Template' : 'Create Co-branded Template'}
                    </h1>
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Co-branded Certificate Templates</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {templates.length === 0 && (
                    <div className="col-span-full text-center py-12 text-gray-500">
                        No templates found. Upload your co-branded template to get started.
                    </div>
                )}
            </div>
        </div>
