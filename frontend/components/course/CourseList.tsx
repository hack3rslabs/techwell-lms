...
export default function CourseList() {
    ...
    return (
        <div className="container py-8">
            ...
            <div className="relative mb-10 w-full overflow-hidden rounded-3xl border border-white/10 shadow-2xl bg-black">
                {/* Background Image */}
                <div className="absolute inset-0 z-0">
                    <Image
                        src={isJobPrepOnly ? "/images/techwell-corporate-bg.png" : "/images/techwell-premium-bg.png"}
                        alt="Hero Background"
                        fill
                        className="object-cover opacity-60 mix-blend-overlay transition-transform duration-1000 hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-950/90 via-indigo-900/70 to-black/80" />
                </div>
                ...
                <div className="relative z-10 px-8 py-16 md:py-20 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="max-w-2xl">
                        <Badge variant="outline" className="mb-4 bg-white/10 text-indigo-200 border-indigo-400/30 px-3 py-1 text-xs tracking-widest uppercase backdrop-blur-sm">
                            {isJobPrepOnly ? "Career Hub" : "Techwell LMS"}
                        </Badge>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 text-white drop-shadow-lg">
                            {isJobPrepOnly ? "Job Placement & " : "Explore "}
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-indigo-300">
                                {isJobPrepOnly ? "Career Programs" : "Courses"}
                            </span>
                        </h1>
                        <p className="text-lg md:text-xl text-indigo-100/90 mb-6 max-w-xl font-medium leading-relaxed drop-shadow-md">
                            {isJobPrepOnly 
                        ...
                        {!isLoading && total > 0 && (
                            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 text-white text-sm font-semibold shadow-lg">
                    ...
                    {/* Right Side Stats / Graphic (Optional) */}
                    <div className="hidden lg:flex flex-col gap-4">
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl transform translate-x-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-indigo-200 text-xs">Average Rating</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl transform -translate-x-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-indigo-200 text-xs">Students Enrolled</p>
                                </div>
                            </div>
                        </div>
                    </div>
