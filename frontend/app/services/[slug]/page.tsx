...
const SERVICE_DATA = {
  'it-infrastructure': {
    ...
    shortDesc: 'Comprehensive IT Solutions backed by 10 years of market leadership. We provide Remote IT Support, IT Asset Management, Maintenance Support, and extensive Infrastructure Installation.',
    icon: SettingsIcon,
    themeColor: 'primary',
    ...
    content: {
      ...
      features: [
        ...
        'Reliable, SLA-Backed Maintenance Support Contracts',
